...
public class CamelNettyhttpSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_PAYLOAD_ROUTER_FANOUT_FIELDS_CONF = "camel.source.payload.router.fanout.fields";
    public static final String CAMEL_SOURCE_PAYLOAD_ROUTER_FANOUT_FIELDS_DEFAULT = "";
    public static final String CAMEL_SOURCE_PAYLOAD_ROUTER_FANOUT_FIELDS_DOC = "Comma-separated list of domain-scoped fields to fan out into separate topics. Format: domain.field (e.g. ticket.tags,ticket.custom_fields,organization.tags). When empty, arrays stay inline in the main event record.";

    public static final String CAMEL_SOURCE_PAYLOAD_ROUTER_FLATTEN_DETAIL_CONF = "camel.source.payload.router.flatten.detail";
    public static final Boolean CAMEL_SOURCE_PAYLOAD_ROUTER_FLATTEN_DETAIL_DEFAULT = false;
    public static final String CAMEL_SOURCE_PAYLOAD_ROUTER_FLATTEN_DETAIL_DOC = "Whether to flatten the detail object fields into the top-level payload. When enabled, detail fields are promoted to top-level with a configurable prefix to avoid name collisions.";

    public static final String CAMEL_SOURCE_PAYLOAD_ROUTER_FLATTEN_DETAIL_PREFIX_CONF = "camel.source.payload.router.flatten.detail.prefix";
    public static final String CAMEL_SOURCE_PAYLOAD_ROUTER_FLATTEN_DETAIL_PREFIX_DEFAULT = "detail_";
    public static final String CAMEL_SOURCE_PAYLOAD_ROUTER_FLATTEN_DETAIL_PREFIX_DOC = "Prefix applied to detail fields when flattening to avoid name collisions with top-level fields (e.g. detail.id becomes detail_id).";

    public static final String CAMEL_SOURCE_PAYLOAD_ROUTER_INCLUDE_EVENT_CONF = "camel.source.payload.router.include.event";
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_PAYLOAD_ROUTER_FANOUT_FIELDS_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_PAYLOAD_ROUTER_FANOUT_FIELDS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_PAYLOAD_ROUTER_FANOUT_FIELDS_DOC);
